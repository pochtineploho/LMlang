package ru.itmo.lmlang;

import ru.itmo.lmlang.ast.ASTBuilder;
import ru.itmo.lmlang.ast.ASTNode;
import ru.itmo.lmlang.bytecode.BytecodeHolder;
import com.fasterxml.jackson.databind.ObjectMapper;
import ru.itmo.lmlang.grammar.LMlangGrammarLexer;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder("D:\\CLionProjects\\LMlang\\cmake-build-debug\\MyANTLRProject.exe", btcFile.getAbsolutePath());
