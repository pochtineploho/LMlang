...
import ru.itmo.lmlang.grammar.LMlangGrammarParser;
import ru.itmo.lmlang.grammar.LMlangGrammarVisitor;
...
public class ASTBuilder implements LMlangGrammarVisitor<ASTNode> {
    ...
    public ASTNode visit(ParseTree parseTree) {
        return switch (parseTree) {
            case LMlangGrammarParser.ArgumentListContext argumentListContext -> visitArgumentList(argumentListContext);
            case LMlangGrammarParser.AssignableContext assignableContext -> visitAssignable(assignableContext);
            case LMlangGrammarParser.ArrayAccessContext arrayAccessContext -> visitArrayAccess(arrayAccessContext);
            case LMlangGrammarParser.ArrayInitContext arrayInitContext -> visitArrayInit(arrayInitContext);
            case LMlangGrammarParser.ArrayInitWithCapacityContext arrayInitWithCapacityContext ->
                    visitArrayInitWithCapacity(arrayInitWithCapacityContext);
            case LMlangGrammarParser.AssignmentContext assignmentContext -> visitAssignment(assignmentContext);
            case LMlangGrammarParser.StatementContext statementContext -> visitStatement(statementContext);
            case LMlangGrammarParser.PrimaryExpressionContext primaryExpressionContext ->
                    visitPrimaryExpression(primaryExpressionContext);
            case LMlangGrammarParser.BlockContext blockContext -> visitBlock(blockContext);
            case LMlangGrammarParser.BreakStatementContext breakStatementContext ->
                    visitBreakStatement(breakStatementContext);
            case LMlangGrammarParser.FunctionCallContext functionCallContext -> visitFunctionCall(functionCallContext);
            case LMlangGrammarParser.ContinueStatementContext continueStatementContext ->
                    visitContinueStatement(continueStatementContext);
            case LMlangGrammarParser.ForInitContext forInitContext -> visitForInit(forInitContext);
            case LMlangGrammarParser.ForPostContext forPostContext -> visitForPost(forPostContext);
            case LMlangGrammarParser.ForStatementContext forStatementContext -> visitForStatement(forStatementContext);
            case LMlangGrammarParser.FunctionDeclContext functionDeclContext -> visitFunctionDecl(functionDeclContext);
            case LMlangGrammarParser.IfStatementContext ifStatementContext -> visitIfStatement(ifStatementContext);
            case LMlangGrammarParser.ParameterListContext parameterListContext ->
                    visitParameterList(parameterListContext);
            case LMlangGrammarParser.ParameterContext parameterContext -> visitParameter(parameterContext);
            case LMlangGrammarParser.PrintStatementContext printStatementContext ->
                    visitPrintStatement(printStatementContext);
            case LMlangGrammarParser.ProgramContext programContext -> visitProgram(programContext);
            case LMlangGrammarParser.ReturnStatementContext returnStatementContext ->
                    visitReturnStatement(returnStatementContext);
            case LMlangGrammarParser.TypeContext typeContext -> visitType(typeContext);
            case LMlangGrammarParser.VarDeclContext varDeclContext -> visitVarDecl(varDeclContext);
            case LMlangGrammarParser.ExpressionContext expressionContext -> visitExpression(expressionContext);
            case TerminalNode terminalNode -> visitTerminal(terminalNode);
            case null -> throw new RuntimeException("Parse tree is null");
            default -> throw new RuntimeException("Unsupported parse tree type: " + parseTree.getClass().getName());
        };
    }
